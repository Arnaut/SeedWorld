...
void PerlinNoise(int height, int width,int octaves,float biais) {
    ...
    int* relief = gen_img(map_height.data,map_height.height,map_height.width,img,(float)0.33,map_height.min,map_height.max);
    gen_biome(relief,map_temp.data,height,width,img);
